...
After generating the term sheet, offer to run the Safer Scenario Simulator to produce a detailed financial analysis. The simulator is at `.claude/vc2-essentials/tools/safer.py`.
