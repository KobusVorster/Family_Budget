...
The simulator is located at `.claude/vc2-essentials/tools/safer_monte_carlo.py`. It produces detailed statistical analysis with charts showing TVPI distributions, IRR analysis, DPI velocity, return attribution, and outcome distributions.
...
```bash
python .claude/vc2-essentials/tools/safer_monte_carlo.py [options]
```
...
```bash
python .claude/vc2-essentials/tools/safer_monte_carlo.py --scenario <preset>
```
...
python .claude/vc2-essentials/tools/safer_monte_carlo.py --sensitivity

# Full sensitivity (8 heatmaps: + repurchase, valuation cap, portfolio concentration, quality, growth/failure)
python .claude/vc2-essentials/tools/safer_monte_carlo.py --sensitivity-full
```
...
```bash
python .claude/vc2-essentials/tools/safer_monte_carlo.py --unicorn-free
```
